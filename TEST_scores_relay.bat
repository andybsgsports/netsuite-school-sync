...
rem tagged scores emails (last 7 days) to andy@bsgsports.com (NOT to the reps), from
...
echo.
python relay_scores_outlook.py --test-to andy@bsgsports.com --since-hours 168 --debug
echo.
